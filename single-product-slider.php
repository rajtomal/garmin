                    ...
                    <div class="single-product-slider swiper-container slider-nav-style-1 small-nav mb-30px">
                        <div class="single-product-slider-wrapper swiper-wrapper">
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/1.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/2.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/3.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/4.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/5.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/6.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="images/product-image/7.jpg" alt="slider-item-img"></a>
                            </div>
                        </div>
                        <!-- Add Arrows -->
                ...
                <div class="new-product-wrapper swiper-wrapper">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product.php" class="image">
                                    ...
                                    <img class="hover-image" src="images/product-image/5.jpg"
                                        alt="Product" />
                                </a>
                                <span class="badges">
                    ...
                    <div class="new-product-item swiper-slide">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product.php" class="image">
                                    <img src="images/product-image/10.jpg" alt="Product" />
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product.php" class="image">
                                    ...
                                    <img class="hover-image" src="images/product-image/11.jpg"
                                        alt="Product" />
                                </a>
                                <span class="badges">
