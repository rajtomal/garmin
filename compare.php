                                    ...
                                    <tr>
                                        ...
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img class="img-responsive"
                                                    src="images/product-image/1.jpg" alt="Compare Product" /></a>
                                            <a href="#" class="category">T-shart</a>
                                            <a href="#" class="title">Ardene Microfiber Tights</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img class="img-responsive"
                                                    src="images/product-image/2.jpg" alt="Compare Product" /></a>
                                            <a href="#" class="category">Coat</a>
                                            <a href="#" class="title">Women's Elizabeth Coat</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img class="img-responsive"
                                                    src="images/product-image/3.jpg" alt="Compare Product" /></a>
                                            <a href="#" class="category">Lomashop</a>
                                            <a href="#" class="title">Parrera Sunglasses -Lomashop</a>
                                        </td>
                                    </tr>
                                    <tr>
