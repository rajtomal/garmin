                        ...
                        <div class="row">
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                                <div class="hero-slide-content slider-animated-1">
                                    ...
                                    <a href="shop-right-sidebar.php" class="btn btn-lg btn-primary btn-hover-dark"> Shop Now <i
                                ...
                                <div class="show-case">
                                    ...
                                    <div class="display-wrapper">
                                        <div class="content-side">
                                            ...
                                            <a href="shop-right-sidebar.php" class="shop-link">Shop Now</a>
                                        </div>
                                        <div class="image-side">
                                            <img src="images/slider-image/display-image.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="single-col">
                    <a href="shop-right-sidebar.php" class="single-banner">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="images/product-image/2.jpg" alt="Product" />
                                                <img class="hover-image" src="images/product-image/10.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="images/product-image/4.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="images/product-image/6.jpg" alt="Product" />
                                                <img class="hover-image" src="images/product-image/14.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 " data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="images/product-image/8.jpg" alt="Product" />
                                                <img class="hover-image" src="images/product-image/16.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">Sale</span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="deal-inner deal-bg position-relative pt-100px pb-100px"
                        data-bg-image="images/deal-img/deal-bg.jpg">
                        <div class="deal-wrapper">
                            ...
                            <a href="single-product-variable.php" class="btn btn-lg btn-primary btn-hover-dark m-auto"> Shop
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="images/testimonial-image/2.png" alt="">
                                </div>
                                <div class="author-name">
                    ...
                    <div class="swiper-slide">
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="images/testimonial-image/3.png" alt="">
                                </div>
                                <div class="author-name">
            ...
            <div class="brand-slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="images/brand-logo/1.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="images/brand-logo/2.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="images/brand-logo/3.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="images/brand-logo/4.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="images/brand-logo/5.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
